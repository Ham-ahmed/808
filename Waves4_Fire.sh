...
if [ -d /usr/share/enigma2/Waves4_Fire ]; then
echo "> removing package please wait..."
sleep 3s 
rm -rf /usr/share/enigma2/Waves4_Fire >/dev/null 2>&1
...
skin=Waves4_Fire
version=2.0
url=https://raw.githubusercontent.com/Ham-ahmed/808/refs/heads/main/Waves4_Fire-MOD_HA.tar.gz
